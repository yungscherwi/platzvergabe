<?php
  ...
  //Hörsaal-Erstellung Funktion
      ...
      $reihen = ""; //initialisiert String
        for($i=0; $q>$i;$i++){ //Ausgabe von Formvorlage entsprechend eingegebener Zahl
          ...
          '<div class="form-group">
              ...
              <input type="anzahlPlaetze" class="form-control" name="anzahlPlaetze'.$i.'" placeholder="Bitte Anzahl der Plätze eingeben" pattern="[0-9]+" title="Es sind nur ganze Zahlen erlaubt."">
            </div>';
        }
      echo $reihen; //Output
    }
    ...
    public function hoersaeleverwalten() {
      ...
      $data['hoersaalID'] = $this->hoersaal_model->get_hoersaalID();
      $data['plaetze'] = $this->hoersaal_model->get_allPlaetze();
